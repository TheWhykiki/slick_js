        ...
        if (_.options.infinite === true && _.options.fade === false) {
            ...
            if (_.slideCount > _.options.slidesToShow) {
                ...
                for (i = _.slideCount; i > _.slideCount - infiniteCount; i -= 1) {
                    slideIndex = i - 1;
                    var slide = _.$slides[slideIndex];
                    var clonedSlide = slide.cloneNode(true);
                    clonedSlide.removeAttribute('id');
                    clonedSlide.setAttribute('data-slick-index', slideIndex - _.slideCount);
                    _.$slideTrack.insertBefore(clonedSlide, _.$slideTrack.firstChild);
                    clonedSlide.classList.add('slick-cloned');
                }
                ...
                for (i = 0; i < infiniteCount + _.slideCount; i += 1) {
                    ...
                    clonedSlide.removeAttribute('id');
                    clonedSlide.setAttribute('data-slick-index', slideIndex + _.slideCount);
                    _.$slideTrack.appendChild(clonedSlide);
                    clonedSlide.classList.add('slick-cloned');
                }

                var clonedSlides = _.$slideTrack.querySelectorAll('.slick-cloned');
                for (i = 0; i < clonedSlides.length; i++) {
                    var clonedSlide = clonedSlides[i];
                    var clonedSlideIds = clonedSlide.querySelectorAll('[id]');
                    for (var j = 0; j < clonedSlideIds.length; j++) {
                        clonedSlideIds[j].removeAttribute('id');
                    }
                }
            }
        }
